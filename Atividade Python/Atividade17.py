...
if tipo == "visitante":
    ...
    horas = 0  # membro não precisa informar horas

# C e D. Verificação das regras com if, elif e else
...
# F. Mensagens já indicam se foi permitido ou não e o motivo